...
void cfg_init() {
	...
	config_set_int(&cfg, CONFIG_CUSTOMIZATION_PATH "p1",   config_get_int(&cfg, CONFIG_CUSTOMIZATION_PATH "p1",   0));
	config_set_int(&cfg, CONFIG_CUSTOMIZATION_PATH "p2",   config_get_int(&cfg, CONFIG_CUSTOMIZATION_PATH "p2",   0));
	config_set_int(&cfg, CONFIG_CUSTOMIZATION_PATH "glow", config_get_int(&cfg, CONFIG_CUSTOMIZATION_PATH "glow", 0));
	...
	selected_p1   = config_get_int(&cfg, CONFIG_CUSTOMIZATION_PATH "p1",   0);
	selected_p2   = config_get_int(&cfg, CONFIG_CUSTOMIZATION_PATH "p2",   0);
	selected_glow = config_get_int(&cfg, CONFIG_CUSTOMIZATION_PATH "glow", 0);
